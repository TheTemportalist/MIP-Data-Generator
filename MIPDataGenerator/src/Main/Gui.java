...
import Main.edittor.IDataOwner;
...
public class Gui extends GuiPanel implements IDataOwner {
	...
	protected void initGui() {
		...
		buttonID = this.block.init(this, buttonID, 520, 260, 220, 280, "Blocks");
	...
	public void passRefreshedData(String listName, int index, Object value) {
		...
		if (listName.equalsIgnoreCase("Authors")) {
			...
			if (index >= 0 && index < data.description.length) {
				data.description[index] = (String)value;
			}
		}
